  ...
  return (
    <>
      <section className="lg:pt-32 pt-16 text-center">
        ...
        <div className="py-3">
          <DescriptionCard
            text="1. 고인의 살아생전 사진/영상"
            subText="그리운 사람의 사진을 보며 그 사람을 추억해보세요"
            idx={0}
          />
          <DescriptionCard
            text="2. TTS"
            subText="그 사람의 목소리로 듣고 싶은 말을 들어보세요"
            idx={1}
          />
          <DescriptionCard
            text="3. 방명록"
            subText="그 사람에게 남기고 싶은 말이 있으신가요?"
            idx={2}
          />
        </div>
      </section>
...
function DescriptionCard({
  ...
  return (
    <div
      className={clsx(
        "w-full flex flex-col-reverse lg:flex-row justify-center items-center my-20 lg:my-40",
        {
    ...
    >
      <div
        className={clsx(
          "lg:w-[41vw] flex flex-col transition-opacity duration-1000 opacity-0 ",
          { "lg:pl-52": isLeft },
          { "lg:pr-52": !isLeft },
        )}
      >
